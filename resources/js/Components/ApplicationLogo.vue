<template>
    <svg xmlns="http://www.w3.org/2000/svg" x="0px" y="0px" width="100" height="100" viewBox="0,0,256,256">
        <defs>
            <linearGradient x1="9.422" y1="8.565" x2="36.928" y2="37.688" gradientUnits="userSpaceOnUse"
                            id="color-1_GnODgj39wOZm_gr1">
