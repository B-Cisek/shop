                ...
                <div class="fixed inset-0 z-40 flex">
                    <TransitionChild as="template" enter="transition ease-in-out duration-300 transform"
                        ...
                        <DialogPanel
                                        ...
                                        <div v-for="section in category.sections" :key="section.name">
                                            ...
                                            <ul role="list"
                                                ...
                                                <li v-for="item in section.items" :key="item.name" class="flow-root">
                                                    <a :href="item.href"
                                                       class="-m-2 block p-2 text-gray-500">{{ item.name }}</a>
                                                </li>
                                            </ul>
                                        </div>
                                    </TabPanel>
                            ...
                            <div class="space-y-6 border-t border-gray-200 px-4 py-6">
                                <div class="flow-root">
                                    <Link :href="route('login')" class="-m-2 block p-2 font-medium text-gray-900">
                                        Zaloguj się
                                    </Link>
                                </div>
                                <div class="flow-root">
                                    <Link :href="route('register')" class="-m-2 block p-2 font-medium text-gray-900">
                                        Załóż konto
                                    </Link>
                                </div>
                            </div>
