...
W
<template>
    <TransitionRoot as="template" :show="cartToggle.isOpened">
        <Dialog as="div" class="relative z-50" @close="cartToggle.setIsOpened(false)">
                                        ...
                                        <div class="flex items-start justify-between">
                                            ...
                                            <div class="ml-3 flex h-7 items-center">
                                                <button
                                                    ...
                                                    @click="cartToggle.setIsOpened(false)"
                                                >
